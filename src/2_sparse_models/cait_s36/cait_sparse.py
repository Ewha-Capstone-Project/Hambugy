# =============================================================================
# cait_build.py  ─  CaiT-S36 ONNX export + TensorRT engine build
#
# 실행:
...
MODEL_DIR          = "cait_s36_model"
DENSE_ONNX         = f"{MODEL_DIR}/cait_s36_dense.onnx"
SPARSE_ONNX        = f"{MODEL_DIR}/cait_s36_sparse.onnx"
DENSE_ENGINE_PATH  = f"{MODEL_DIR}/cait_s36_dense_fp16.engine"
SPARSE_ENGINE_PATH = f"{MODEL_DIR}/cait_s36_sparse_fp16.engine"
